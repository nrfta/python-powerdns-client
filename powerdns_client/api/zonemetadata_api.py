...
class ZonemetadataApi(object):
    ...
    def create_metadata(self, metadata, server_id, zone_id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.create_metadata(metadata, server_id, zone_id, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.create_metadata_with_http_info(metadata, server_id, zone_id, **kwargs)  # noqa: E501
        else:
            (data) = self.create_metadata_with_http_info(metadata, server_id, zone_id, **kwargs)  # noqa: E501
            return data

    def create_metadata_with_http_info(self, metadata, server_id, zone_id, **kwargs):  # noqa: E501
        """Creates a set of metadata entries  # noqa: E501

        Creates a set of metadata entries of given kind for the zone. Existing metadata entries for the zone with the same kind are not overwritten.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_metadata_with_http_info(metadata, server_id, zone_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['metadata', 'server_id', 'zone_id']  # noqa: E501
    ...
    def modify_metadata(self, metadata, server_id, zone_id, metadata_kind, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.modify_metadata(metadata, server_id, zone_id, metadata_kind, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.modify_metadata_with_http_info(metadata, server_id, zone_id, metadata_kind, **kwargs)  # noqa: E501
        else:
            (data) = self.modify_metadata_with_http_info(metadata, server_id, zone_id, metadata_kind, **kwargs)  # noqa: E501
            return data

    def modify_metadata_with_http_info(self, metadata, server_id, zone_id, metadata_kind, **kwargs):  # noqa: E501
        """Replace the content of a single kind of domain metadata.  # noqa: E501

        Creates a set of metadata entries of given kind for the zone. Existing metadata entries for the zone with the same kind are removed.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.modify_metadata_with_http_info(metadata, server_id, zone_id, metadata_kind, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['metadata', 'server_id', 'zone_id', 'metadata_kind']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
